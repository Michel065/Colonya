...
main: build/main.o build/mapmanager.o  build/includes.o build/BiomeManager.o
	$(CXX) -o main build/main.o build/mapmanager.o build/includes.o build/BiomeManager.o $(SFMLFLAGS) 	
